...
:page-seo-description: A tutorial on MicroProfile Fault Tolerance integrated with Istio Fault Tolerance 
and an example on how to develop fault-tolerance microservices using Istio's Retry policy and MicroProfile Fault Tolerance's Fallback mechanism.
