...
----
include::finish/inventory/src/main/java/io/openliberty/guides/inventory/InventoryResource.java[][tags=**;!copyright,mpRetry,fallback,fallbackMethod;]
----
...
[source, Java, linenums, role='code_column']
----
include::finish/inventory/src/main/java/io/openliberty/guides/inventory/InventoryResource.java[][tags=**;!copyright,fallback,fallbackMethod;]
----
...
----
include::finish/services.yaml[tags=**;!invConfig,configHide;]
----

traffic.yaml
[source, yaml, linenums, role='code_column']
----
include::finish/traffic.yaml[tags=**;!istioRetry;]
----
...
[hotspot=retryOn file=0]`retryOn` field. Since your paused `system` service responds with a `503` response code, 
